#!/usr/bin/env python3
"""
Submit reasoning (or hybrid) answers to Botcha.ai.
...
Output: same JSON envelope as botcha_get_token.py
"""
import sys
import json
import http.client
...
try:
    ...
    if result.get("success"):
        print(json.dumps({
            ...
            "strategy_notes": f"Reasoning submitted and verified in {result.get('solveTimeMs', elapsed)}ms.",
        }))
    else:
        print(json.dumps({
            "success": False,
